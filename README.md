...
```qml
// Your .qml file
import com.wearily.WeaCore 1.0 // Importing registered components
...
```qml
import QtQuick 2.12
import com.wearily.WeaCore 1.0

Window {
    visible: true
    width: 400
    height: 400
    title: "WeaCore Example"
}
...
- Source code comments: see `include/WeaCore/*.h`
